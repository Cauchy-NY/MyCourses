...
public class SendMailUtils {
    ...
    public SendMailUtils() {
        this.setInitData("smtp.163.com", "myappverification@163.com", "code123456");
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        test.setInitData("smtp.163.com", "myappverification@163.com", "code123456");
        test.simpleMailSend("1092792221@qq.com", "测试", "测试能不能发邮件！！！");
